...
export const site = {
  ...
  treatments: [
    { title: 'Braces', slug: '/braces/', img: '/images/braces-for-teens.webp',
      alt: 'Dr. Benkovich with a smiling teen braces patient at Benkovich Orthodontics in Annapolis, MD',
      blurb: 'Comfortable metal & clear braces for kids, teens, and adults — with fun colors kids love.' },
    { title: 'Invisalign®', slug: '/invisalign/', img: '/images/invisalign-for-adults.webp',
      alt: 'Dr. Benkovich with an adult Invisalign patient at Benkovich Orthodontics in Annapolis, MD',
      blurb: 'A virtually invisible, removable way to straighten your smile. A favorite for adults and teens.' },
    { title: 'Early Orthodontics', slug: '/early-orthodontics/', img: '/images/braces-for-kids.webp',
      alt: 'Dr. Benkovich with a young orthodontic patient at Benkovich Orthodontics in Annapolis & Chester, MD',
      blurb: 'Gentle first visits around age 7 — often there’s nothing to do yet but keep a friendly eye on things.' },
    { title: 'Adult Orthodontics', slug: '/adult-orthodontics/', img: '/images/braces-for-adults.webp',
      alt: 'Dr. Benkovich with an adult orthodontic patient at Benkovich Orthodontics in Annapolis, MD',
      blurb: 'It’s never too late. Discreet braces and Invisalign that fit a busy adult life.' },
    { title: 'Retainers', slug: '/retainers/', img: '/images/retainers.webp',
      alt: 'A patient placing a clear retainer at Benkovich Orthodontics in Annapolis, MD',
